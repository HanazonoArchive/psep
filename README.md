...
│   └── psep-command.js          # UserPromptSubmit: detect /psep, emit strict|relaxed
├── skills/psep/
│   ├── SKILL.md                 # Full PSEP philosophy (all 7 principles)
│   └── README.md                # Skill usage reference
├── AGENTS.md                    # Layer model + scope + conflict resolution
├── LICENSE                      # MIT
└── README.md                    # This file
```
